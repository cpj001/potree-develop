...
export class Sidebar{
	...
	initClippingTool(){
...

		{
			...
			elClipTask.selectgroup({title: "剖切"});
...

		{
			...
			elClipMethod.selectgroup({title: "剖切方式"});
	...
	initClassificationList(){
		...
		addClassificationItem(0, '不分类');
		addClassificationItem(1, '取消分类');
		addClassificationItem(2, '地面');
		addClassificationItem(3, '低植被');
		addClassificationItem(4, '中等植被');
		addClassificationItem(5, '高植被');
		addClassificationItem(6, '建筑');
		addClassificationItem(7, '低点云(噪点)');
		addClassificationItem(8, '关键点');
		addClassificationItem(9, '水');
		addClassificationItem(12, '反转');
	}
	...
	initNavigation(){
		...
		let elCameraProjection = $(`
			<selectgroup id="camera_projection_options">
				<option id="camera_projection_options_perspective" value="PERSPECTIVE">透视</option>
				<option id="camera_projection_options_orthigraphic" value="ORTHOGRAPHIC">正视</option>
			</selectgroup>
		`);
		elNavigation.append(elCameraProjection);
		elCameraProjection.selectgroup({title: "相机投影"});
	...
	initSettings(){
...

		{
			...
			elSplatQuality.selectgroup({title: "模型质量"});
